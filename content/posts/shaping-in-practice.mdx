...
Shape Up is a fantastic framework to use but remember that local adaptations might
be necessary to make it work for your team. These things are not set in stone and
you can tweak processes as your team grows & matures or when the context you are
in changes.
